                ...
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-bold">Daftar Pengguna</h3>
                     <a href="{{ route('users.create') }}" 
                        class="px-4 py-2 bg-yellow-600 text-black rounded hover:bg-yellow-700">Tambah User</a>
                </div>
                    ...
                    <table class="min-w-full border border-gray-300">
                        ...
                        <tbody>
                            @forelse($users as $key => $user)
                                ...
                                @empty
                                <tr>
                                    <td colspan="5" class="border px-4 py-2 text-center">Belum ada data user.</td>
                                </tr>
                                @endforelse
                                </tbody>
                          </table>
